 ...
 */
public class UndoAssetTypeChange extends UndoCommand {

    @NotNull private Map<String, Placeable> placedObjectsSnapshot = new HashMap<>();

    public UndoAssetTypeChange(@NotNull ClientLevelData clientLevelData, @NotNull Set<String> selectedPlaceables) {
    ...
    public UndoCommand getRedoCommand() {
        return new UndoAssetTypeChange(clientLevelData, clientLevelData.getSelectedPlaceables());
    }

    @Nullable
    @Override
    public String getUndoMessage() {
        return LangManager.getItem("undoTypeChange");
    }

    @Nullable
    @Override
    public String getRedoMessage() {
        return LangManager.getItem("redoTypeChange");
    }
