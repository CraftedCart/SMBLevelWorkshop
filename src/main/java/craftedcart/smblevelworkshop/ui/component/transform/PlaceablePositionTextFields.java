 ...
 */
public class PlaceablePositionTextFields extends PositionTextFields {

    public PlaceablePositionTextFields(@NotNull MainScreen mainScreen, @Nullable TextField nextTextField) {
